/*
Strassen Matrix Multiplication problem using Divide & Conquer approach
*/
...
m multiply(m m1, m m2)
{
	...
	P1 = multiply(A, subt(F, H));
	P2 = multiply(addit(A, B), H);
	P3 = multiply(addit(C, D), E);
	P4 = multiply(D, subt(G, E));
	P5 = multiply(addit(A, D), addit(E, H));
	P6 = multiply(subt(B, D), addit(G, H));
	P7 = multiply(subt(A, C), addit(E, F));

	Q1 = addit(subt(addit(P5, P4), P2), P6);
	Q2 = addit(P1, P2);
	Q3 = addit(P3, P4);
	Q4 = subt(subt(addit(P1, P5), P3), P7);
